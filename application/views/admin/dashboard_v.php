        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li><a href="#sales-chart1" data-toggle="tab">Belum Memilih</a></li>
              <li><a href="#sales-chart2" data-toggle="tab">Sudah Memilih</a></li>
              <li class="active"><a href="#revenue-chart" data-toggle="tab">Hasil Sementara</a></li>
